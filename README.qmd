...
# Monthly indoorCO2map.com Summary for the month of `r lubridate::ymd("2025-09-20")  |> lubridate::month(label = TRUE, abbr = FALSE)`
...
#| warning: false
#| message: false
ylim_max <- max(buildings_long_df_med$median_co2) + 300
...
Here's a histogram showing how many measurements have been recorded each week since the start of the project. Over the last 12 months there have been `r measurements_this_year` building measurements this year which is `r measurements_this_year/12` per month or `r measurements_this_year/52` per week. 
